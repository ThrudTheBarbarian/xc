...
- (void)printUsage
    ...
    fprintf(stderr,
            ...
            "  -fbounds-check             Checked build: every subscript is checked\n"
            "                             against its allocation's own header, and a\n"
            "                             failure reports the site, the real bounds\n"
            "                             and a symbolised stack before aborting.\n"
            "                             Debug-time only; native (arm64) targets,\n"
