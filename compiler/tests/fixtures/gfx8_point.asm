...
;; Source: tests/fixtures/gfx8_point.xt
...
_main:
    ...
    STA $BC
    ; mcall
    JSR _bezierTo__i16_i16_i16_i16
    ; (expr stmt discarded)
    ; Assert
    LDA _Assert
    STA $9A
    ...
    STA $84
    STX $85
_str_3: .byte $44,$4F,$4E,$45,$20,$31,$36,$0A,0
    ; mcall
    JSR _printf
    ; (expr stmt discarded)
    ; return
