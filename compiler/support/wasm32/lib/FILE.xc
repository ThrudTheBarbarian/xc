...
// FILE.xc — wasm32 Unix-style stream I/O.
// ========================================================
//
// The FILE resolved for the wasm32 backend (ahead of
// support/generic/lib on the include path), keyed by backend
// ARCHITECTURE like the wasm32 Stdio.xc / Heap.xc / Math.xc.
//
...
// console primitive `_putc` (declared by Stdio.xc; the JS loader
// provides it) — and stubs ConsoleIn to EOF, since the sweep runs
// have no interactive stdin. No inline asm.
//
