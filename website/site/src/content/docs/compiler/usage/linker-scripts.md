...
5. Compile with `xcc -m ./your-file.lnk`. If the file is next to the shipped layouts under `support/<platform>/layouts/`, you can reference it by name without the path.
