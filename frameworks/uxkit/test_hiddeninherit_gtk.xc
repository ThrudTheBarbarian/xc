// test_hiddeninherit_gtk.xc — the GTK half of hiding a container hides its NATIVE children too.
//
...
void main(void)
    ...
    if (gFails == (i32)0)
        {
        Stdio.printf("PASS: hidden is inherited by native descendants (GTK)\n");
        }
    else
        {
