// showcase_gem2.xc — SHEET 2 (containers + navigation) of the GEM contact sheet: one window, every widget (native
...
class SheetApp : Object<UXApplicationDelegate>
    ...
    i32 applicationDidStart(UXApplication* a)
        ...
        win = new UXWindow();
        a.addWindow(win);
        win.open((u8*)"sheet", UXGeom.make(80, 80, 440, 630), content);
        buildSheet2(content);
        win.tree.finalise();
        win.displayAll();
