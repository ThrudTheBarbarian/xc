// showcase_web2.xc — SHEET 2 (containers + navigation) of the web contact sheet: every widget in one window on the
...
void main(void)
    ...
    win.open((u8*)"sheet", UXGeom.make(0, 0, 440, 630), content);
    buildSheet2(content);
    win.tree.finalise();
    win.displayAll();
    wd.webPresentAll();
